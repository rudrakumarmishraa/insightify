        ...
        <main className="grid md:grid-cols-2 h-screen text-white bg-gray-900">
            ...
            <section className="hidden md:flex flex-col gap-16 pb-2 md:pt-10 lg:pt-16 md:pl-10 lg:pl-16">
                ...
                <ul>
                    ...
                    <p className="pb-5 ml-8 text-gray-400 lg:text-lg md:text-small">Used <b>gpt-3.5-turbo</b> model for conversation with users with fast response, leveraging OpenAI node js packages to write backend code.</p>
